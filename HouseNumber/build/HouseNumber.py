...
class HouseNumber:
    def __init__(self, master=None):
        ...
        from Complement.build import Complement
        ...
        ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\Apollo\Desktop\UltimateRecicla\HouseNumber\build\assets\frame0")
